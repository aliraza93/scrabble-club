                ...
                >
                    ...
                    >
                        ...
                        >
                            <button
                                type="button"
                                id="createMemberModalButton"
                                data-modal-target="createMemberModal"
                                data-modal-toggle="createMemberModal"
...
defineProps({
    ...
    search: String, // Assuming this prop is passed from the parent component
});
